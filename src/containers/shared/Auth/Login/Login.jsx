        ...
        return (
            <div className="container-fluid login-movie">
                <div className="login-wrap">
                    {stateLogin.error && <div className="text-danger loginError">{stateLogin.error}</div>}
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="sign-in-htm">
                                    <div className="group my-3">
                                        ...
                                        <input id="user" type="text" name="taiKhoan" className="input" onChange={handleChange} />
                                    </div>
                                    <div className="group my-5">
                                        <label htmlFor="pass" className="label">Password</label>
                                        <input id="pass" type="password" name="matKhau" className="input" data-type="password" onChange={handleChange} />
                                    </div>
                                    {/* <div className="group">
